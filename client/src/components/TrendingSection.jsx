...
const TrendingSection = () => {
  const testData = [
    ...
    {
      id: 2,
      title: 'IBPS PO Prelims 2024 Mock Test',
      subtitle: 'Exam date announced',
    ...
    {
      id: 3,
      title: 'Railway RRB NTPC CBT-1 2024',
    ...
    {
      id: 4,
      title: 'SSC CHSL 2024 Test Series',
      image: "https://res.cloudinary.com/dh85jgh9d/image/upload/v1760609256/download7_bb3qf2.jpg",
      totalTests: 200,
      pypCount: 40,
    },
    ...
    <section className="py-12 sm:py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="mt-3 sm:mt-4 max-w-2xl text-base sm:text-lg text-gray-500 mx-auto px-4">
          Practice with the latest pattern of questions asked in recent exams and get ahead in the competition.
        </p>
